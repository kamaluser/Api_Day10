...
namespace CourseApp.UI.Controllers
{
    ...
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> Create(StudentCreateRequest dto)
        {
            ...
            {
                multipartContent.Add(new StreamContent(dto.Photo.OpenReadStream()), "Photo", dto.Photo.FileName);
            }
        ...
        public async Task<IActionResult> Edit(StudentCreateRequest editRequest, int id)
        {
            ...
            {
                multipartContent.Add(new StreamContent(editRequest.Photo.OpenReadStream()), "Photo", editRequest.Photo.FileName);
            }
